...
### Cas sous-déterminé
LSRN a été adapté pour $m < n$ en appliquant la projection aléatoire sur $A^T$. Certains résultats préliminaires ont été produits de manière similaire au cas sur-déterminé, mais il reste encore certains aspect à analyser. Les résultats devraient être présents dans le rapport final!
